...
console.log(color(`║ `, 'white'), color(`[•]`, 'gold'), color(`Bot Version : 2.0                            ║`, 'white'))
console.log(color(`║ `, 'white'), color(`[•]`, 'gold'), color(`Creado      : 20/1/22                       ║`, 'white'))
console.log(color(`╚═══════════════════════════════════════════════════╝`, 'white'))
...
function doProgress()
{
	...
	if ( progress >= 1 )
	{
		...
		exec(`screenfetch -A Deepin`, (error, stdout, stderr) => {
			console.log(stdout), console.log(bgcolor('AlcatrazBot, espero les guste :)', 'red'))})}, 200 ) ;
	}
	else
	{
...
console.log(color(figlet.textSync(`${settings.NombreBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping('By Team-Alcatraz' ,{ flashStyle: term.brightWhite })
